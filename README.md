# AI Product Marketing Designer PRO v4.0
...
### 5. Phase 3: 產品市場分析 (v4.0 新功能)
*   **深度市場洞察**: 基於 Phase 1 選定的視覺策略，生成完整的市場分析報告
*   **產品核心價值分析**: 主要特色、核心優勢、解決的痛點
*   **目標市場定位**: 文化洞察、消費習慣、語言特性、搜尋趨勢
*   **競爭對手分析**: 自動識別 3 個主要競爭對手，分析其行銷策略、優勢與劣勢
*   **買家人物誌**: 生成 3 個詳細的潛在客戶描繪，包含基本資料、興趣、痛點、搜尋關鍵字

### 6. Phase 4: 內容與 SEO 策略 (v4.0 新功能)
*   **內容主題規劃**: 為每個主題生成標題、描述、主要關鍵字、長尾關鍵字
*   **SEO 優化指導**: 關鍵字密度建議、語意關鍵字、內外部連結策略
*   **互動元素建議**: 2-3 個互動元素建議（問卷調查、互動式圖表、產品比較工具等）
*   **行動呼籲文案**: 3 個自然且具說服力的 CTA 文案建議
*   **網頁生成提示詞**: 
    *   **AI Studio 版本**: 適用於 Google AI Studio，生成 React + Tailwind CSS 網頁（500-800 字詳細提示詞）
    *   **Gamma.app 版本**: 適用於 Gamma.app，生成簡報/網頁結構（400-600 字詳細提示詞）
*   **圖片自動引用**: 如果 Phase 2 已生成圖片，提示詞會自動引用對應的圖片檔名
*   **一鍵複製與開啟**: 複製提示詞後自動開啟對應的生成平台
